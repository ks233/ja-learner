...
<div align="center">
    ...
    <br />
    <span>句子拆解 • 汉字注音 • 外来语翻译 • 快速查词 • 参考翻译 • AI讲解</span>
</div> 
<h3 align="center">
...
* **基本分析**：用不同颜色区分句子成分，为句子中的汉字注音。
* **单词查询**：点击单词快速查询 MOJi 辞書，哪里不会点哪里。
* **参考翻译**：支持谷歌翻译与 ChatGPT 翻译，把握句子整体含义。
* **片假不留**：在片假名上方标注英语翻译，淦 TMD 片假名。
* **游戏文本分析**：吸附游戏窗口，配合游戏文本提取工具，实时分析游戏文本。
